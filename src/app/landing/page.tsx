  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-6 py-12">
      <div className="w-full max-w-md text-center">
        ...
        <p className="mt-3 font-story text-lg text-text-muted">
        ...
        <form onSubmit={handleSubmit} className="mt-12">
          <div className="flex gap-2">
            <input
              ...
              required
              className="flex-1 rounded-sm border border-border bg-surface px-4 py-3 text-sm text-text-primary placeholder-text-muted/60 outline-none focus:border-accent"
            />
            <button
              type="submit"
              disabled={status === 'loading'}
              className="shrink-0 rounded-sm bg-accent px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-accent-dark disabled:opacity-60"
            >
